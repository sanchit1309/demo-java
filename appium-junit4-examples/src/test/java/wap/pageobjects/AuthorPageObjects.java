...
public class AuthorPageObjects {
	...
	@FindBy(xpath = "//ul[contains(@class,'newsList')]//li//a[string-length()>0 and contains(@href,'show')]")
	...
	public WebElement getDateTimeOfAticle(WebElement we) {
		...
		return we.findElement(
				By.xpath("./../../following-sibling::div[@class='time_blk']//span[contains(@class,'normal')]"));
