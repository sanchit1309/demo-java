...
public class MenuPage extends BaseTest {
	...
	public void verifyMenuOptions() {
		...
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("Main Menu").split("\\s*,\\s*")));
		...
		System.out.println(actualMenuListHref);
		System.out.println(actualMenuListHref);
		actualMenuListHref.forEach(keyword -> {
			if ((keyword.contains("economictimes") || keyword.contains("indiatimes"))
					&& !keyword.contains("javascript")) {
				// System.out.println(keyword);
				int resCode = HTTPResponse.checkResponseCode(keyword);
				softAssert.assertEquals(resCode, 200,
						"<br>- Sub Menu link <a href=" + keyword + ">" + keyword + "</a> is throwing " + resCode);
			}
		});
		softAssert.assertTrue(VerificationUtil.listActualInExpected(expectedMenuItemList, actualMenuItemList),
				"Actual list of menu items is not matching the expected list of menu items, missing options:"
						+ VerificationUtil.getMissingMenuOptionList() + "<br>Actual List " + actualMenuItemList
	...
	public void verifyMarketsSubMenu() {
		...
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("MarketsSubMenu").split("\\s*,\\s*")));

		// List<String> allSubMenuLinkHref =
		// menuPageMethods.getSubMenuLinkHref();
		homePageMethods.clickFooterMenuICon();
		WaitUtil.sleep(3000);
		...
		actualMenuListL3Href.forEach(keyword -> {
			if ((keyword.contains("economictimes") || keyword.contains("indiatimes"))
				...
				int resCode = HTTPResponse.checkResponseCode(keyword);
				softAssert.assertEquals(resCode, 200,
						"<br>- L3 Menu link <a href=" + keyword + ">" + keyword + "</a> is throwing " + resCode);
			}
		});
	...
	public void verifyNewsSubMenu() {
		...
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("NewsSubMenu").split("\\s*,\\s*")));
		...
		actualMenuListHref.forEach(keyword -> {
			if ((keyword.contains("economictimes") || keyword.contains("indiatimes"))
				...
				softAssert.assertEquals(resCode, 200,
						"<br>- Sub Menu link <a href=" + keyword + "> " + keyword + " </a> is throwing " + resCode);
				// softAssert.assertFalse(keyword.contains(".cms"), "<br>- Sub
				// Menu link <a href=" + keyword + ">link</a> is not short
				// url");
			}
		});
		softAssert.assertTrue(VerificationUtil.listActualInExpected(expectedMenuItemList, actualMenuItemList),
	...
	public void verifyIndustrySubMenu() {
		...
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("IndustrySubMenu").split("\\s*,\\s*")));
	...
	public void verifySmallBizSubMenu() {
		...
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("SmallBizSubMenu").split("\\s*,\\s*")));
	...
	public void verifyWealthSubMenu() {
		...
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("WealthSubMenu").split("\\s*,\\s*")));
	...
	@Test(description = "Verifiy Brand Solutions Submenu Option List", groups = { "Menu Option" }, priority = 6, enabled = false)
	public void verifyBrandSolutionsSubMenu() {
		...
		// List<String> expectedMenuItemList = new
		// ArrayList<>(Arrays.asList(testData.get("BrandSolutionsSubMenu").split("\\s*,\\s*")));
	...
	public void verifyMFSubMenu() {
		...
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("MFSubMenu").split("\\s*,\\s*")));
	...
	public void verifyTechSubMenu() {
		...
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("TechSubMenu").split("\\s*,\\s*")));
	...
	public void verifyOpinionSubMenu() {
		...
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("OpinionSubMenu").split("\\s*,\\s*")));
	...
	public void verifyNRISubMenu() {
		...
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("NRISubMenu").split("\\s*,\\s*")));
	...
	public void verifyMagazinesSubMenu() {
		String menuName = "Panache";
		softAssert = new SoftAssert();
		testData = ExcelUtil.getTestDataRow(excelPath, "verifyMagazinesSubMenu", 1);
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("MagazinesSubMenu").split("\\s*,\\s*")));
	...
	@Test(alwaysRun = true, description = "Verifiy Slideshows Submenu Option List", groups = {
			"Menu Option" }, priority = 12, enabled = false)
	public void verifySlideshowsSubMenu() {
		...
		List<String> expectedMenuItemList = new ArrayList<>(
				Arrays.asList(testData.get("SlideshowsSubMenu").split("\\s*,\\s*")));
