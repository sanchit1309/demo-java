...
import pwa.pageobjects.SearchObjects;
...
public class SearchMethods {
	...
	public boolean setSearchText(String searchedVal) {
		boolean flag = false;
		try {
			searchObjects.getSearchBar().clear();
			searchObjects.getSearchBar().sendKeys(searchedVal);
			flag = true;
	...
	public String openSeachBar() {
		try {
			WaitUtil.sleep(5000);
			// WaitUtil.explicitWaitByElementToBeClickable(driver, 10,
			// searchObjects.getSearchIcon());
